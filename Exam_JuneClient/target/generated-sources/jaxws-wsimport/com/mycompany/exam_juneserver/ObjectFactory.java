 ...
 * generated in the com.mycompany.exam_juneserver package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetDetailsResponse_QNAME = new QName("http://exam_juneserver.mycompany.com/", "getDetailsResponse");
    private final static QName _GetDetails_QNAME = new QName("http://exam_juneserver.mycompany.com/", "getDetails");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mycompany.exam_juneserver
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exam_juneserver.mycompany.com/", name = "getDetailsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exam_juneserver.mycompany.com/", name = "getDetails")
