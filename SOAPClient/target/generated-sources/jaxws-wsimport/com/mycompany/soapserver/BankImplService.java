 ...
 * 
 */
@WebServiceClient(name = "BankImplService", targetNamespace = "http://soapserver.mycompany.com/", wsdlLocation = "http://localhost:8080/bank?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKIMPLSERVICE_QNAME = new QName("http://soapserver.mycompany.com/", "BankImplService");
    ...
    public Bank getBankImplPort() {
        return super.getPort(new QName("http://soapserver.mycompany.com/", "BankImplPort"), Bank.class);
    }
    ...
    public Bank getBankImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapserver.mycompany.com/", "BankImplPort"), Bank.class, features);
    }
